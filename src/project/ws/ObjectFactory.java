...
public class ObjectFactory {
    ...
    private final static QName _GetArtistById_QNAME = new QName("http://ws.project/", "getArtistById");
    private final static QName _DeleteSongResponse_QNAME = new QName("http://ws.project/", "deleteSongResponse");
    private final static QName _GetSongByIdResponse_QNAME = new QName("http://ws.project/", "getSongByIdResponse");
    ...
    private final static QName _GetSongById_QNAME = new QName("http://ws.project/", "getSongById");
    ...
    private final static QName _GetArtistByIdResponse_QNAME = new QName("http://ws.project/", "getArtistByIdResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.project/", name = "getArtistById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.project/", name = "getSongByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.project/", name = "getSongById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.project/", name = "getArtistByIdResponse")
